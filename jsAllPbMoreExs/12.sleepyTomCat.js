...
{
 let numRest = Number(input[0]);

 let normaForPlay = 30000;
  let timePlayRest = numRest * 127;
  let timePlayYorkDay = (365 - numRest) * 63 ;
  let totalPlay = timePlayRest + timePlayYorkDay;
  let diference = Math.abs(30000 -totalPlay);
  let hour = Math.floor(diference /60);
  let minutes = diference % 60;


  if (totalPlay >= normaForPlay){
